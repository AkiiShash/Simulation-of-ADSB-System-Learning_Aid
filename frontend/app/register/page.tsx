...
const registerScheme = Yup.object().shape({
	...
	role: Yup.string().required('User type is required').oneOf(['A', 'U'], 'Invalid choice'),
...
function page() {
	...
	return (
		<div className="w-screen h-screen flex flex-col items-center justify-center">
			<div className="p-4 shadow-md rounded-md" style={{ width: 400 }}>
				<h1 className="text-3xl font-bold my-6">Register</h1>
				<Formik initialValues={initialValues} onSubmit={handleSubmit} validationSchema={registerScheme}>
					{({ handleSubmit, handleChange, errors, values }) => (
						<>
							<div className="my-2">
								...
								<Button label="Register" className="w-full mt-6" onClick={handleSubmit} />
